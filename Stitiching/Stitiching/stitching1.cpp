...
int main(int argc, char *argv[])
{
	...
	cout << "提取特征点的时间：" << (clock() - Clock)*1.0 / CLOCKS_PER_SEC << "s" << endl;
	...
	cout << "匹配特征点的时间：" << (clock() - Clock)*1.0 / CLOCKS_PER_SEC << "s" << endl;
	...
	cout << "拼接时间：" << (clock() - Clock)*1.0 / CLOCKS_PER_SEC << "s" << endl;
	...
	imwrite("E:\\input\\拼接结果.jpg", imageTransform1);
	waitKey();
	return 0;
}
